...
Copyright notice from the current upstream license:
...
Win-CodexBar is a Windows port inspired by CodexBar and contains additional Windows/Tauri/Rust implementation work.

## codexcontrol

Project: https://github.com/ademisler/codexcontrol

License: MIT

Win-CodexBar documents that portions of its Windows multi-account Codex implementation under `rust/src/codex_accounts/` are derived from codexcontrol and retain:

> Copyright (c) 2026 Adem Isler
